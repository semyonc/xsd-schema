//! XPath2 DOM navigation trait and types
//!
//! This module provides a read-only navigation interface for XPath2 evaluation.
//! It follows the design in `DOM_NAVIGATOR_DESIGN.md`.
//!
//! ## Core Types
//!
